        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 text-balance">
              Descubra Sua <span className="text-primary">Paixão</span> por Calçados
            </h1>
            <p className="text-xl lg:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto text-pretty">
              Explore nossa coleção exclusiva de calçados premium com estilo, conforto e qualidade incomparáveis
            </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1">
            <div className="mb-8 animate-slide-up">
              ...
              <p className="text-muted-foreground text-lg">Descubra os calçados mais populares da nossa coleção</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 animate-fade-in">
              ...
              <p className="text-muted-foreground">
                Materiais selecionados e acabamento impecável em todos os produtos
              </p>
            </div>
            ...
            <div className="text-center p-6 animate-fade-in">
              ...
              <p className="text-muted-foreground">Receba seus calçados em até 48h em todo o Brasil</p>
            </div>
            ...
            <div className="text-center p-6 animate-fade-in">
              ...
              <p className="text-muted-foreground">30 dias para troca e devolução sem complicações</p>
            </div>
          </div>
        </div>
      </section>
